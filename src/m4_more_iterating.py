...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 5
    actual = count_positive_sines([3, 1, 4, 1, 5, 9, 2, 6])
    print()
...
def count_positive_sines(numbers):
    ...
    Type hints:
      :type numbers: list or tuple (of numbers)
    """
    # I changed the name from sequence to numbers so that Pycharm didn't get
    # mad.
    # ------------------------------------------------------------------
    # DONE 7
    #   Note that you should write its TEST function first (above).
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 18
    actual = sum_first_n([3, 14, 1, 59], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 77
    actual = sum_first_n([3, 14, 1, 59], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
